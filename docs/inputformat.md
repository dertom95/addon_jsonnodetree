...
{
	"trees": [ /*nodetrees*/ ],
	"customUI" : [ /*base64 encoded python-code that overwrites hooks for custom ui for properties, additional operators and more*/ ],
	"customUI-file" : /*filename to a python-script to be executed to set custom ui callbacks*/
}
```
